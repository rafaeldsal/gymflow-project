...
Nosso sistema terão as seguintes entidades com seus respectivos campos:
...
* Exercício (Exercise)
  ...
  * imgUrl (String - ULR de uma imaem demonstrativa do exercício, se houver)
